...
--
-- Servidor: localhost
-- Tiempo de generación: 28-08-2017 a las 06:39:02
...
('ASIMILADOR', 7, 1, 1, 12, 0, 0, 0, 0),
('CONVERGENTE', 7, 15, 12, 12, 0, 0, 0, 0),
('DIVERGENTE', 12, 12, 12, 12, 0, 0, 0, 0);
...
CREATE TABLE `Preferencias_WEB` (
  ...
  `Tipo` int(1) NOT NULL,
  `Motivo` varchar(50) NOT NULL DEFAULT 'Ninguno'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `Preferencias_WEB`
--

INSERT INTO `Preferencias_WEB` (`Nombre_Sitio`, `Tipo`, `Motivo`) VALUES
('nro_resultados', 9, '10'),
('www.energia-nuclear.net', 1, 'Ninguno'),
('www.pref2.com', 1, 'Ninguno'),
('www.pref6.com', 1, 'Ninguno'),
('www.pref7.com', 1, 'Ninguno'),
('www.rgdo3.com', 0, 'Ninguno'),
('www.rgdo4.com', 0, 'Ninguno'),
('www.rgdo5.com', 0, 'Ninguno'),
('www.rgdo6.com', 0, 'Ninguno'),
('www.wikipedia.org', 0, 'Ninguno');
